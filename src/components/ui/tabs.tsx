...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div className="relative" ref={tabsListRef}>
      ...
      />
      <div
        className="absolute rounded-full border border-transparent bg-black shadow-sm dark:border-input dark:bg-input/30 transition-all duration-500 ease-in-out"
