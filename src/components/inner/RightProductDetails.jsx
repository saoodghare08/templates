...
const RightProductDetails = () => {
  ...
  return (
    <div className="w-full max-w-sm space-y-5 text-sm font-serif text-gray-700">
      ...
      {/* Add to Bag Button */}
      <button id="product-detail-top" className="w-full bg-black text-white font-semibold py-3 rounded-full flex items-center justify-center gap-2 shadow hover:bg-gray-950 transition-colors">
        Add to Cart
      </button>
